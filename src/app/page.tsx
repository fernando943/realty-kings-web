...
const WHATSAPP = "https://wa.me/17876679389?text=" + encodeURIComponent("Hola, quiero vender mi propiedad. Vi su página de Realty Kings.");
      ...
      <div className="relative max-w-7xl mx-auto px-5 lg:px-10 pt-28 lg:pt-32 pb-14 lg:pb-20 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div className="animate-fade-up">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a href={`tel:${PHONE_TEL}`} onClick={() => track("tel_click", { location: "hero" })} className="btn btn-yellow !py-4 !px-7 text-base animate-pulse-gold">
